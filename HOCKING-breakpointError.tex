...
\tab{penalty-real-data}{Breakpoint detection error of several
  ...
  penalty. The exponent of the points $d_i$, length $l_i$, and
  variance $\hat s_i$ terms in the penalty is shown with the train and
  test annotation error (percent incorrect regions). }
