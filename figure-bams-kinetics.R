...
p <- ggplot(subset(results,statistic=="errors"),
  ...
  scale_y_continuous(paste("Percent of correctly predicted",
                           "annotations on test set profiles",sep="\n"),
