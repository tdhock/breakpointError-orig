...
png("figure-variable-density-annotation-cost.png",h=600,w=1200,res=200)
##library(tikzDevice);options(tikzDocumentDeclaration="\\documentclass[11pt]{memoir}",tikzMetricsDictionary="tikzMetrics")
##tikz("figure-variable-density-annotation-cost.tex")
print(p)
dev.off()#;system("firefox figure-variable-density-annotation-cost.png&")
